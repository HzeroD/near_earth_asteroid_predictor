...
This guide assumes the workload identity pool `github-pool2` already exists and should be reused.
...
# Set up Workload Identity Federation using the existing pool github-pool2
